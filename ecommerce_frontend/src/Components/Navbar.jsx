...
export default function Navbar({ searchProducts }) {
   ...
   const endUserSession = () => {
      ...
      // Set the userLoggedIn state to false
      setIUserLoggedIn(false);
      ...
      window.location = '/';
      /******  11ff5ee0-8db0-4677-a7ac-71130a8a53bf  *******/
   };
               ...
               <div className="navbar-siblings-parent px-4 flex w-full text-center justify-between items-center ">
                     ...
                     <div className=''>
                        <nav className='font-albert'>
                           <ul className='bg-transparent text-[#444] flex flex-row gap-x-6 py-1' style={{ fontSize: '16px' }}>
                              ...
                              <li>
                                 <button className='relative group hover:text-primary transition-all duration-300'>
                  ...
                  <div className="third_part_of_navbar flex gap-x-4 p-2 justify-center align-items-middle">
                     ...
                     >
                        ...
                        <div className="flex mt-1 lg:w-65 h-[40px] relative font-albert">
                           {/* Search Icon */}
                        ...
                        {isUserLoggedIn === true ? (
                           <>
                              <div className="flex items-center lg:order-2">
                                 <div ref={userDropdownRef} className="hidden text-end animate-fadeinup bg-gray-50 absolute end-6 top-14 z-50 my-4 w-56 list-none rounded rounded-t-md divide-y divide-gray-300 shadow-2xl dark:bg-gray-700 dark:divide-gray-600">
                                    <div className=" pe-3 rounded-t-md">
                                       <button
                                    ...
                                    <div className="py-3 px-4 text-center">
                                       <span className="block text-sm font-semibold text-gray-900 dark:text-white capitalize">{userName}</span>
                                    ...
                                    <ul className="text-start py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                       <li>
                                          <a href="#" className="block py-2 px-4 text-sm hover:bg-primary-light hover:text-white  dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My profile</a>
                                       </li>
                                       <li>
                                          <a href="#" className="block py-2 px-4 text-sm hover:bg-primary-light hover:text-white dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Account settings</a>
                                       </li>
                                    </ul>
                                    <ul className="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                       <li>
                                          <a href="/cart" className="flex items-center py-2 px-4 text-sm hover:bg-primary-light hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                             <i className="fa fa-shopping-cart pe-2" aria-hidden="true"></i>
                                             Cart
                                          </a>
                                       </li>
                                       <li>
                                          <a href="#" className="flex items-center py-2 px-4 text-sm hover:bg-primary-light hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                             <svg className="mr-2 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"> <path d="m1.56 6.245 8 3.924a1 1 0 0 0 .88 0l8-3.924a1 1 0 0 0 0-1.8l-8-3.925a1 1 0 0 0-.88 0l-8 3.925a1 1 0 0 0 0 1.8Z" /> <path d="M18 8.376a1 1 0 0 0-1 1v.163l-7 3.434-7-3.434v-.163a1 1 0 0 0-2 0v.786a1 1 0 0 0 .56.9l8 3.925a1 1 0 0 0 .88 0l8-3.925a1 1 0 0 0 .56-.9v-.786a1 1 0 0 0-1-1Z" /> <path d="M17.993 13.191a1 1 0 0 0-1 1v.163l-7 3.435-7-3.435v-.163a1 1 0 1 0-2 0v.787a1 1 0 0 0 .56.9l8 3.925a1 1 0 0 0 .88 0l8-3.925a1 1 0 0 0 .56-.9v-.787a1 1 0 0 0-1-1Z" /> </svg>
                                             Collections
                                          </a>
                                       </li>
                                       <li>
                                          <a href="#" className="flex justify-between items-center py-2 px-4 text-sm hover:bg-primary-light hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                    ...
                                    <ul className="py-1 text-gray-500 text-center dark:text-gray-400" aria-labelledby="dropdown">
                                       <li className='scursor-pointer' onClick={endUserSession} >
                                          <a className="block py-2 px-4 text-sm cursor-pointer hover:bg-primary-light hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                             Sign out
                                          </a>
                                       </li>
                                    </ul>
