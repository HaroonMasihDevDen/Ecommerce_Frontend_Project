                ...
                <nav class="bg-green-600 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                    <div class="flex flex-wrap justify-between items-center ">
                        <div class="flex justify-start items-center">
                            <button id="toggleSidebar" aria-expanded="true" aria-controls="sidebar" class="hidden p-2 mr-3 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-green-400 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                            ...
                            <button aria-expanded="true" aria-controls="sidebar" class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden hover:text-gray-900 hover:bg-green-400 focus:bg-gray-100 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                        ...
                        <div class="flex items-center lg:order-2">
                            ...
                            <button id="toggleSidebarMobileSearch" type="button" class="p-2 text-gray-500 rounded-lg lg:hidden hover:text-gray-900 hover:bg-green-400 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                            ...
                            <button type="button" onClick={openUserPanel} class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                                <span class="sr-only">Open user menu</span>
                                <img class="w-8 h-8 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo" />
                            </button>
                            {/* <!-- Dropdown menu --> */}
                            <div ref={userDropdownRef} class=" hidden text-end animate-fadeinup  bg-green-100 absolute end-6 top-14 z-50 my-4 w-56  list-none rounded rounded-t-md divide-y divide-gray-300 shadow-2xl dark:bg-gray-700 dark:divide-gray-600">
                                <div class="bg-green-700 pe-3 rounded-t-md">
                                    <button
                                ...
                                <div class="py-3 px-4 text-center">
                                    <span class="block text-sm font-semibold text-gray-900 dark:text-white">My Name</span>
                                    <span class="block text-sm text-gray-500 truncate dark:text-gray-400">My Email</span>
                                </div>
                                <ul class="text-start py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                    <li>
                                        <a href="#" class="block py-2 px-4 text-sm hover:bg-green-400 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My profile</a>
                                    </li>
                                    <li>
                                        <a href="#" class="block py-2 px-4 text-sm hover:bg-green-400 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Account settings</a>
                                    </li>
                                </ul>
                                <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                    <li>
                                        <a href="/cart" class="flex items-center py-2 px-4 text-sm hover:bg-green-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                        <i className="fa fa-shopping-cart pe-2" aria-hidden="true"></i>
                                            Cart
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="flex items-center py-2 px-4 text-sm hover:bg-green-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                    ...
                                    <li>
                                        <a href="#" class="flex justify-between items-center py-2 px-4 text-sm hover:bg-green-400 dark:hover:bg-gray-600 dark:hover:text-white">
                                ...
                                <ul class="py-1 text-gray-500 text-center dark:text-gray-400" aria-labelledby="dropdown">
                                    <li>
                                        <a class="block py-2 px-4 text-sm hover:bg-green-400 dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
