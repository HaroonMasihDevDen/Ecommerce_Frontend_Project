   ...
   return (
      <div>
         <header class="antialiased">
            <nav class="bg-pile-300 text-white border-gray-200 px-4 lg:px-6 py-2 dark:bg-gray-800">
               <div class="flex flex-wrap justify-between items-center ">
                  <div class="flex justify-start items-center">

                     <a href="https://flowbite.com" class="flex mr-4">
                        {/* <img src="/logo1.png" class="mr-3 h-8" alt="Aurora Logo" /> */}
                     ...
                     <form action="#" method="GET" class="hidden lg:block lg:pl-2">
                        ...
                        <div className="relative mt-1 lg:w-96">
                           ...
                           <input type="text" name="product" id="topbar-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" />
                        </div>
                     </form>
                  </div>
                  <div className='flex' >
                              ...
                              <>
                                 <li>
                                    <div class="flex items-center lg:order-2">
                                       ...
                                       {/* <!-- Dropdown menu --> */}
                                       <div ref={userDropdownRef} class=" hidden text-end animate-fadeinup  bg-pile-50 absolute end-6 top-14 z-50 my-4 w-56  list-none rounded rounded-t-md divide-y divide-gray-300 shadow-2xl dark:bg-gray-700 dark:divide-gray-600">
                                          <div class="bg-pile-700 pe-3 rounded-t-md">
                                             <button
                                          ...
                                          <ul class="text-start py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                             <li>
                                                <a href="#" class="block py-2 px-4 text-sm hover:bg-pile-400 hover:text-white  dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My profile</a>
                                             </li>
                                             <li>
                                                <a href="#" class="block py-2 px-4 text-sm hover:bg-pile-400 hover:text-white dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Account settings</a>
                                             </li>
                                          </ul>
                                          <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                                             <li>
                                                <a href="/cart" class="flex items-center py-2 px-4 text-sm hover:bg-pile-400 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                                   <i className="fa fa-shopping-cart pe-2" aria-hidden="true"></i>
                                                   Cart
                                                </a>
                                             </li>
                                             <li>
                                                <a href="#" class="flex items-center py-2 px-4 text-sm hover:bg-pile-400 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                             ...
                                             <li>
                                                <a href="#" class="flex justify-between items-center py-2 px-4 text-sm hover:bg-pile-400 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                          ...
                                          <ul class="py-1 text-gray-500 text-center dark:text-gray-400" aria-labelledby="dropdown">
                                             <li className='scursor-pointer' onClick={endUserSession} >
                                                <a class="block py-2 px-4 text-sm cursor-pointer hover:bg-pile-400 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">
                                                   Sign out
                                                </a>
                                             </li>
                                          </ul>
